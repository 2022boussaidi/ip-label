package com.example.Main.UserJourneyService.service;
...
public class UserJourneyService {
    ...
    @Autowired
    public UserJourneyService(RestTemplate restTemplate) {
        this.restTemplate = restTemplate;
    }

    public ResponseEntity<JsonNode> getUserJourney(String auth) {
        String apiUrl = "https://demo-ekara.ip-label.net/script-api/scripts";
